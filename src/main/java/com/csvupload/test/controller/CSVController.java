package com.csvupload.test.controller;
...
public class CSVController {
	 @Autowired
	  ...
	  public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file) {
	    ...
	    System.out.println("XXXXXX 1111 : "+file.toString());
	    if (CSVHelper.hasCSVFormat(file)) {
	    	System.out.println("XXXXXX 2222 : "+CSVHelper.hasCSVFormat(file));
	      try {
	        fileService.save(file);
	        System.out.println("XXXXXX 3333 : "+CSVHelper.hasCSVFormat(file));
	        ...
	        return ResponseEntity.status(HttpStatus.OK).body(new ResponseMessage(message,fileDownloadUri));
	    	  ...
	    	  System.out.println("XXXXXX 4444 : "+e.getMessage());
